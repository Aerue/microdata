...
abstract class Object {
    ...
    */
    public function search($field, $keyword) {
        if(!is_string ($this->$field)) {
            \Application\Application::fatalError('Object::search(' . $field . ', ' . $keyword . ') : le champs \'' . $field . '\' n\'est pas une chaîne de caractères.');
        }
    ...
    */
    public static function getPropertiesStatic($object, $all = true) {
        if(!is_object($this)) {
            \Application\Application::fatalError('Object::getPropertiesStatic() : $object n\'est pas un objet : ' . get_class($this));
        }
